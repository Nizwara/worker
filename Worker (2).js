...
// Variables
const rootDomain = "killer-vpn.biz.id"; // Ganti dengan domain utama kalian
const serviceName = "dark"; // Ganti dengan nama workers kalian
const apiKey = "fc5c95b787d4783c6c941c6378937c31f39ff"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "nizwara94@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "8a95a1beacbeb938c0543174ccf99f75"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "7f764ce26ff6b8953ffaa3e40f7e3ee9"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Nizwara/worker/main/output.txt";
...
<body>
    ...
    <h1 class="quantum-title">
            <a href="https://t.me/sampiiiiu" target="_blank">DARK-SYSTEM</a>
        </h1>
...
export default {
  async fetch(request, env, ctx) {
    try {
      ...
      const KEY = env.API_KEY; // Get the API key from secrets
      const CHECK_API_BASE = env.CHECK_API_BASE; // Get base URL from secrets
      const CHECK_API = `${CHECK_API_BASE}/key=${KEY}/ip=`;
